...
export const APP_STRINGS = {
  nl: {
    ...
    businessNameLabel:"Bedrijfsnaam", vatNumberLabel:"Btw-nummer", bioLabel:"Korte omschrijving", becomeProSubmit:"Start met diensten aanbieden", saveServicesBtn:"Diensten opslaan", messagePlaceholder:"Typ een bericht...", chatSendBtn:"Verstuur bericht",
  ...
  fr: {
    ...
    businessNameLabel:"Nom de l'entreprise", vatNumberLabel:"Numéro de TVA", bioLabel:"Courte description", becomeProSubmit:"Commencer à proposer des services", saveServicesBtn:"Enregistrer les services", messagePlaceholder:"Écris un message...", chatSendBtn:"Envoyer le message",
  ...
  de: {
    ...
    businessNameLabel:"Firmenname", vatNumberLabel:"USt-IdNr.", bioLabel:"Kurzbeschreibung", becomeProSubmit:"Jetzt Dienstleistungen anbieten", saveServicesBtn:"Dienste speichern", messagePlaceholder:"Nachricht schreiben...", chatSendBtn:"Nachricht senden",
  ...
  en: {
    ...
    businessNameLabel:"Business name", vatNumberLabel:"VAT number", bioLabel:"Short bio", becomeProSubmit:"Start offering services", saveServicesBtn:"Save services", messagePlaceholder:"Type a message...", chatSendBtn:"Send message",
  ...
  es: {
    ...
    businessNameLabel:"Nombre de la empresa", vatNumberLabel:"Número de IVA", bioLabel:"Descripción breve", becomeProSubmit:"Empezar a ofrecer servicios", saveServicesBtn:"Guardar servicios", messagePlaceholder:"Escribe un mensaje...", chatSendBtn:"Enviar mensaje",
  ...
  ar: {
    ...
    businessNameLabel:"اسم الشركة", vatNumberLabel:"الرقم الضريبي", bioLabel:"نبذة قصيرة", becomeProSubmit:"ابدأ بتقديم الخدمات", saveServicesBtn:"حفظ الخدمات", messagePlaceholder:"اكتب رسالة...", chatSendBtn:"إرسال الرسالة",
  ...
  fa: {
    ...
    businessNameLabel:"نام کسب‌وکار", vatNumberLabel:"شماره مالیاتی", bioLabel:"معرفی کوتاه", becomeProSubmit:"شروع ارائه خدمات", saveServicesBtn:"ذخیره خدمات", messagePlaceholder:"پیامی بنویسید...", chatSendBtn:"ارسال پیام",
  ...
  tr: {
    ...
    businessNameLabel:"Şirket adı", vatNumberLabel:"KDV numarası", bioLabel:"Kısa biyografi", becomeProSubmit:"Hizmet sunmaya başla", saveServicesBtn:"Hizmetleri kaydet", messagePlaceholder:"Bir mesaj yaz...", chatSendBtn:"Mesajı gönder",
  ...
  ru: {
    ...
    businessNameLabel:"Название компании", vatNumberLabel:"Номер плательщика НДС", bioLabel:"Краткое описание", becomeProSubmit:"Начать предлагать услуги", saveServicesBtn:"Сохранить услуги", messagePlaceholder:"Введите сообщение...", chatSendBtn:"Отправить сообщение",
  ...
  zh: {
    ...
    businessNameLabel:"公司名称", vatNumberLabel:"增值税号", bioLabel:"简介", becomeProSubmit:"开始提供服务", saveServicesBtn:"保存服务", messagePlaceholder:"输入消息...", chatSendBtn:"发送消息",
