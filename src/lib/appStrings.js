...
export const APP_STRINGS = {
  nl: {
    ...
    businessNameLabel:"Bedrijfsnaam", vatNumberLabel:"Btw-nummer", bioLabel:"Korte omschrijving", becomeProSubmit:"Start met diensten aanbieden", becomeProFailed:"Kon je vakman-profiel niet aanmaken. Probeer het opnieuw.", saveServicesBtn:"Diensten opslaan", messagePlaceholder:"Typ een bericht...", chatSendBtn:"Verstuur bericht",
    ...
    portfolioTitle:"Portfolio", captionLabel:"Bijschrift (optioneel)", noPortfolioYet:"Nog geen foto's.", deletePhotoBtn:"Foto verwijderen", portfolioSaveFailed:"Kon deze wijziging niet opslaan. Probeer het opnieuw.", portfolioDeleteFailed:"Kon deze foto niet verwijderen. Probeer het opnieuw.",
  ...
  fr: {
    ...
    portfolioTitle:"Portfolio", captionLabel:"Légende (facultatif)", noPortfolioYet:"Pas encore de photos.", deletePhotoBtn:"Supprimer la photo", portfolioSaveFailed:"Impossible d'enregistrer cette modification. Réessaie.", portfolioDeleteFailed:"Impossible de supprimer cette photo. Réessaie.",
  ...
  en: {
    ...
    businessNameLabel:"Business name", vatNumberLabel:"VAT number", bioLabel:"Short bio", becomeProSubmit:"Start offering services", becomeProFailed:"Couldn't set up your pro profile. Please try again.", saveServicesBtn:"Save services", messagePlaceholder:"Type a message...", chatSendBtn:"Send message",
    ...
    portfolioTitle:"Portfolio", captionLabel:"Caption (optional)", noPortfolioYet:"No photos yet.", deletePhotoBtn:"Delete photo", portfolioSaveFailed:"Couldn't save this change. Please try again.", portfolioDeleteFailed:"Couldn't delete this photo. Please try again.",
  ...
  es: {
    ...
    portfolioTitle:"Portafolio", captionLabel:"Descripción (opcional)", noPortfolioYet:"Todavía no hay fotos.", deletePhotoBtn:"Eliminar foto", portfolioSaveFailed:"No se pudo guardar este cambio. Inténtalo de nuevo.", portfolioDeleteFailed:"No se pudo eliminar esta foto. Inténtalo de nuevo.",
  ...
  ar: {
    ...
    businessNameLabel:"اسم الشركة", vatNumberLabel:"الرقم الضريبي", bioLabel:"نبذة قصيرة", becomeProSubmit:"ابدأ بتقديم الخدمات", becomeProFailed:"تعذّر إنشاء ملفك كمحترف. يرجى المحاولة مرة أخرى.", saveServicesBtn:"حفظ الخدمات", messagePlaceholder:"اكتب رسالة...", chatSendBtn:"إرسال الرسالة",
    ...
    portfolioTitle:"معرض الأعمال", captionLabel:"تعليق (اختياري)", noPortfolioYet:"لا توجد صور بعد.", deletePhotoBtn:"حذف الصورة", portfolioSaveFailed:"تعذّر حفظ هذا التغيير. يرجى المحاولة مرة أخرى.", portfolioDeleteFailed:"تعذّر حذف هذه الصورة. يرجى المحاولة مرة أخرى.",
  ...
  fa: {
    ...
    businessNameLabel:"نام کسب‌وکار", vatNumberLabel:"شماره مالیاتی", bioLabel:"معرفی کوتاه", becomeProSubmit:"شروع ارائه خدمات", becomeProFailed:"پروفایل حرفه‌ای شما ایجاد نشد. لطفاً دوباره امتحان کنید.", saveServicesBtn:"ذخیره خدمات", messagePlaceholder:"پیامی بنویسید...", chatSendBtn:"ارسال پیام",
    ...
    portfolioTitle:"نمونه‌کارها", captionLabel:"توضیح (اختیاری)", noPortfolioYet:"هنوز عکسی نیست.", deletePhotoBtn:"حذف عکس", portfolioSaveFailed:"این تغییر ذخیره نشد. لطفاً دوباره امتحان کنید.", portfolioDeleteFailed:"این عکس حذف نشد. لطفاً دوباره امتحان کنید.",
  ...
  tr: {
    ...
    businessNameLabel:"Şirket adı", vatNumberLabel:"KDV numarası", bioLabel:"Kısa biyografi", becomeProSubmit:"Hizmet sunmaya başla", becomeProFailed:"Profesyonel profilin oluşturulamadı. Lütfen tekrar dene.", saveServicesBtn:"Hizmetleri kaydet", messagePlaceholder:"Bir mesaj yaz...", chatSendBtn:"Mesajı gönder",
    ...
    portfolioTitle:"Portfolyo", captionLabel:"Açıklama (isteğe bağlı)", noPortfolioYet:"Henüz fotoğraf yok.", deletePhotoBtn:"Fotoğrafı sil", portfolioSaveFailed:"Bu değişiklik kaydedilemedi. Lütfen tekrar dene.", portfolioDeleteFailed:"Bu fotoğraf silinemedi. Lütfen tekrar dene.",
  ...
  ru: {
    ...
    portfolioTitle:"Портфолио", captionLabel:"Подпись (необязательно)", noPortfolioYet:"Пока нет фотографий.", deletePhotoBtn:"Удалить фото", portfolioSaveFailed:"Не удалось сохранить это изменение. Попробуйте ещё раз.", portfolioDeleteFailed:"Не удалось удалить это фото. Попробуйте ещё раз.",
  ...
  zh: {
    ...
    businessNameLabel:"公司名称", vatNumberLabel:"增值税号", bioLabel:"简介", becomeProSubmit:"开始提供服务", becomeProFailed:"无法创建您的专业人士资料，请重试。", saveServicesBtn:"保存服务", messagePlaceholder:"输入消息...", chatSendBtn:"发送消息",
    ...
    portfolioTitle:"作品集", captionLabel:"说明（可选）", noPortfolioYet:"暂无照片。", deletePhotoBtn:"删除照片", portfolioSaveFailed:"无法保存此更改，请重试。", portfolioDeleteFailed:"无法删除此照片，请重试。",
