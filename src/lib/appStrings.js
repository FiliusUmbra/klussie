...
export const APP_STRINGS = {
  nl: {
    ...
    serviceLocationLabel:"Waar moet dit gebeuren?", serviceLocationHome:"Bij mij thuis", serviceLocationOneTime:"Eenmalig adres", serviceLocationLoading:"Locaties laden...", serviceLocationHomeNeedsAddress:"We hebben het adres van je woning nog nodig, eenmalig.", serviceLocationOneTimeHint:"Voer het adres in waar de klus moet gebeuren.",
  ...
  de: {
    ...
    serviceLocationLabel:"Wo soll das stattfinden?", serviceLocationHome:"Bei mir zu Hause", serviceLocationOneTime:"Einmalige Adresse", serviceLocationLoading:"Standorte werden geladen...", serviceLocationHomeNeedsAddress:"Wir brauchen einmalig noch die Adresse deiner Wohnung.", serviceLocationOneTimeHint:"Gib die Adresse ein, an der die Arbeit stattfinden soll.",
  ...
  ar: {
    ...
    serviceLocationLabel:"أين يجب أن يتم هذا؟", serviceLocationHome:"في منزلي", serviceLocationOneTime:"عنوان لمرة واحدة", serviceLocationLoading:"جارٍ تحميل المواقع...", serviceLocationHomeNeedsAddress:"ما زلنا بحاجة إلى عنوان منزلك، لمرة واحدة فقط.", serviceLocationOneTimeHint:"أدخل العنوان الذي يجب أن يتم فيه العمل.",
  ...
  fa: {
    ...
    serviceLocationLabel:"این کار کجا باید انجام شود؟", serviceLocationHome:"در خانه‌ی من", serviceLocationOneTime:"آدرس یک‌بار مصرف", serviceLocationLoading:"در حال بارگذاری مکان‌ها...", serviceLocationHomeNeedsAddress:"هنوز به آدرس خانه‌ی شما نیاز داریم، فقط یک‌بار.", serviceLocationOneTimeHint:"آدرسی را که کار باید در آن انجام شود وارد کنید.",
  ...
  tr: {
    ...
    serviceLocationLabel:"Bu iş nerede yapılacak?", serviceLocationHome:"Evimde", serviceLocationOneTime:"Tek seferlik adres", serviceLocationLoading:"Konumlar yükleniyor...", serviceLocationHomeNeedsAddress:"Evinizin adresine bir kereliğine daha ihtiyacımız var.", serviceLocationOneTimeHint:"İşin yapılacağı adresi girin.",
  ...
  zh: {
    ...
    serviceLocationLabel:"服务地点在哪里？", serviceLocationHome:"在我家", serviceLocationOneTime:"一次性地址", serviceLocationLoading:"正在加载地址...", serviceLocationHomeNeedsAddress:"我们还需要您家的地址，只需一次。", serviceLocationOneTimeHint:"请输入需要上门服务的地址。",
