...
export const APP_STRINGS = {
  nl: {
    ...
    toastBooked:"Geboekt! De vakman is op de hoogte gebracht.", toastThanks:"Bedankt voor je beoordeling!", toastReviewFailed:"Beoordeling versturen is niet gelukt. Probeer het opnieuw.", toastQuoteSent:"Offerte verstuurd naar klant.", toastQuoteFailed:"Offerte versturen is niet gelukt. Probeer het opnieuw.",
  ...
  fr: {
    ...
    toastBooked:"Réservé ! Le pro a été notifié.", toastThanks:"Merci pour ton avis !", toastReviewFailed:"L'envoi de l'avis a échoué. Réessaie.", toastQuoteSent:"Devis envoyé au client.", toastQuoteFailed:"L'envoi du devis a échoué. Réessaie.",
  ...
  de: {
    ...
    toastBooked:"Gebucht! Der Profi wurde benachrichtigt.", toastThanks:"Danke für deine Bewertung!", toastReviewFailed:"Bewertung konnte nicht gesendet werden. Bitte erneut versuchen.", toastQuoteSent:"Angebot an Kunde gesendet.", toastQuoteFailed:"Angebot konnte nicht gesendet werden. Bitte erneut versuchen.",
  ...
  en: {
    ...
    toastBooked:"Booked! The pro has been notified.", toastThanks:"Thanks for your review!", toastReviewFailed:"Couldn't send your review. Please try again.", toastQuoteSent:"Quote sent to customer.", toastQuoteFailed:"Couldn't send your quote. Please try again.",
  ...
  es: {
    ...
    toastBooked:"¡Reservado! El profesional ha sido avisado.", toastThanks:"¡Gracias por tu valoración!", toastReviewFailed:"No se pudo enviar tu valoración. Inténtalo de nuevo.", toastQuoteSent:"Presupuesto enviado al cliente.", toastQuoteFailed:"No se pudo enviar tu presupuesto. Inténtalo de nuevo.",
  ...
  ar: {
    ...
    toastBooked:"تم الحجز! تم إخطار المحترف.", toastThanks:"شكرًا على تقييمك!", toastReviewFailed:"تعذّر إرسال تقييمك. حاول مرة أخرى.", toastQuoteSent:"تم إرسال العرض إلى العميل.", toastQuoteFailed:"تعذّر إرسال عرضك. حاول مرة أخرى.",
  ...
  fa: {
    ...
    toastBooked:"رزرو شد! متخصص باخبر شد.", toastThanks:"از نظر شما ممنونیم!", toastReviewFailed:"ارسال نظر شما ناموفق بود. دوباره امتحان کنید.", toastQuoteSent:"پیشنهاد برای مشتری ارسال شد.", toastQuoteFailed:"ارسال پیشنهاد شما ناموفق بود. دوباره امتحان کنید.",
  ...
  tr: {
    ...
    toastBooked:"Rezerve edildi! Profesyonel bilgilendirildi.", toastThanks:"Değerlendirmen için teşekkürler!", toastReviewFailed:"Değerlendirmen gönderilemedi. Lütfen tekrar dene.", toastQuoteSent:"Teklif müşteriye gönderildi.", toastQuoteFailed:"Teklifin gönderilemedi. Lütfen tekrar dene.",
  ...
  ru: {
    ...
    toastBooked:"Забронировано! Специалист уведомлён.", toastThanks:"Спасибо за отзыв!", toastReviewFailed:"Не удалось отправить отзыв. Попробуйте ещё раз.", toastQuoteSent:"Предложение отправлено клиенту.", toastQuoteFailed:"Не удалось отправить предложение. Попробуйте ещё раз.",
  ...
  zh: {
    ...
    toastBooked:"已预订！专业人士已收到通知。", toastThanks:"感谢你的评价！", toastReviewFailed:"评价发送失败，请重试。", toastQuoteSent:"报价已发送给客户。", toastQuoteFailed:"报价发送失败，请重试。",
    ...
    statusAcceptedPendingLocation:"确认地址", disclosureConsentTitle:"分享地址并确认预约", disclosureConsentBody:"到目前为止，{name} 只知道您所在的市/区。分享您的确切地址以确认预约。", disclosureConsentApproveBtn:"分享地址并确认", disclosureConsentNote:"您的地址永远不会对其他专业人员可见。", aiFillManuallyBtn:"手动填写",
  },
};
