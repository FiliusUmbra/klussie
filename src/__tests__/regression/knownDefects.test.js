...
// Captured 2026-08-12. Each of these renders as literal text to a customer where a
// real character belongs — the euro signs are in invoice totals, quote prices and
// the flexi tax tracker, which is where someone is most likely to see one.
const BASELINE = {
  u20ac: 9, // € — invoice totals, budgets, quote prices, boost price
  u2022: 3, // • — separators
  u2013: 1, // – — en dash
  u00b7: 1, // · — middle dot
};
const BASELINE_TOTAL = 14;
